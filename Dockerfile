...
LABEL org.label-schema.schema-version="1.0" \
      ...
      org.label-schema.docker.param="ACD_MOUNT_SUBDIR=Encrypted directory to mount relative to ACD_MOUNT_SUBDIR, ACD_MOUNT_SUBDIR=ACD directory to mount, ENCFS6_CONFIG=Location of EncFS config, ENCFS6_PASSWORD=Password for decrypting EncFS, MOUNT_UID=UID for mounted files, MOUNT_GID=GID for mounted files"
